...
async def generate_testcases(
    ...
    class BuildTestcaseVisitor(TestcaseGroupVisitor):
        ...
        async def visit(self, entry: GenerationTestcaseEntry):
            ...
            if entry.metadata.copied_from is not None:
                ...
                if tests_with_same_call:
                    ...
                    console.console.print(
                        ...
                        f'is generated by the same call as [item]{ref_entry.group_entry}[/item].'
                    )
                    console.console.print(
            ...
            if not same_call and entry.metadata.copied_to.inputPath.is_file():
                tests_with_same_digest = self.test_digests[
                    digest_file(entry.metadata.copied_to.inputPath)
                ]
